...
class CheckResponse(google.protobuf.message.Message):
    ...
    ) -> typing.Optional[typing_extensions.Literal["success", "error"]]: ...
...
class Order(google.protobuf.message.Message):
    ...
    class _DirectionEnumTypeWrapper(
        google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_Direction.V],
        builtins.type,
    ):
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor = ...
...
class QueryRequest(google.protobuf.message.Message):
    ...
    class _QueryType:
        V = typing.NewType("V", builtins.int)
    class _QueryTypeEnumTypeWrapper(
        google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_QueryType.V],
        builtins.type,
    ):
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor = ...
