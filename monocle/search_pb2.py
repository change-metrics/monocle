...
_REPOSSUMMARY = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            ...
            full_name="monocle_search.ReposSummary.RepositorySummary",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
...
_REPOSSUMMARY.fields_by_name["RepositorySummary"].message_type = _REPOSUMMARY
