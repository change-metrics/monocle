...
val encode_task_data_add_request : TaskDataTypes.task_data_add_request -> Js.Json.t Js.Dict.t
(** [encode_task_data_add_request v dict] encodes [v] int the given JSON [dict] *)

val encode_task_data_add_response : TaskDataTypes.task_data_add_response -> Js.Json.t Js.Dict.t
(** [encode_task_data_add_response v dict] encodes [v] int the given JSON [dict] *)
...
val decode_task_data_add_request : Js.Json.t Js.Dict.t -> TaskDataTypes.task_data_add_request
(** [decode_task_data_add_request decoder] decodes a [task_data_add_request] value from [decoder] *)

val decode_task_data_add_response : Js.Json.t Js.Dict.t -> TaskDataTypes.task_data_add_response
(** [decode_task_data_add_response decoder] decodes a [task_data_add_response] value from [decoder] *)
