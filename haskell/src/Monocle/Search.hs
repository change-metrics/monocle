...
newtype SearchSuggestionsRequest = SearchSuggestionsRequest{searchSuggestionsRequestIndex
                                                            :: Hs.Text}
...
instance HsProtobuf.Message SearchSuggestionsRequest where
        encodeMessage _
          SearchSuggestionsRequest{searchSuggestionsRequestIndex =
...
instance HsJSONPB.FromJSONPB SearchSuggestionsRequest where
        parseJSONPB
          = (HsJSONPB.withObject "SearchSuggestionsRequest"
...
instance HsJSONPB.ToSchema SearchSuggestionsRequest where
        declareNamedSchema _
          = do let declare_index = HsJSONPB.declareSchemaRef
               ...
               let _ = Hs.pure SearchSuggestionsRequest <*>
...
data SearchSuggestionsResponse = SearchSuggestionsResponse{searchSuggestionsResponseTaskTypes
                                                           :: Hs.Vector Hs.Text,
...
instance HsProtobuf.Message SearchSuggestionsResponse where
        encodeMessage _
          SearchSuggestionsResponse{searchSuggestionsResponseTaskTypes =
...
instance HsJSONPB.FromJSONPB SearchSuggestionsResponse where
        parseJSONPB
          = (HsJSONPB.withObject "SearchSuggestionsResponse"
               (\ obj ->
...
instance HsJSONPB.ToSchema SearchSuggestionsResponse where
        declareNamedSchema _
          = do let declare_task_types = HsJSONPB.declareSchemaRef
               searchSuggestionsResponseTaskTypes <- declare_task_types
                                                       Proxy.Proxy
               ...
               searchSuggestionsResponsePriorities <- declare_priorities
                                                        Proxy.Proxy
               let declare_severities = HsJSONPB.declareSchemaRef
               searchSuggestionsResponseSeverities <- declare_severities
                                                        Proxy.Proxy
               let _ = Hs.pure SearchSuggestionsResponse <*>
